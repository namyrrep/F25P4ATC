...
public class AirControlTest extends TestCase {
    ...
    public void testInternalNodeRemoveSpanning() throws Exception {
        ...
        // Now add spanning object that crosses the x=512 boundary
    ...
    public void testInternalNodeSimplifyLeftFlyweightRightLeaf()
        ...
        // Add object to right side - forces internal node
        assertTrue(w.add(new Balloon("rightSide", 600, 100, 100, 10, 10, 10,
            "hot", 5)));
    ...
    public void testIntersect() throws Exception {
        ...
        String result = w.intersect(0, 0, 0, 512, 1024, 1024);
        assertTrue(result.contains("left"));
        assertFalse(result.contains("right"));
        ...
        // Test 3: Query box only in right half (x >= 512)
        // Tests: region.x + region.xWidth > qx
        result = w.intersect(520, 0, 0, 400, 1024, 1024);
        assertFalse(result.contains("left"));
        assertTrue(result.contains("right"));
    ...
    public void testBinTreeDeleteEdgeCases() throws Exception {
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("solo", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        tree = w.printbintree();
        ...
        // ============================================================
        assertTrue(w.add(new Drone("giant", 0, 0, 0, 1020, 1020, 1020, "mega",
            4)));
        tree = w.printbintree();
        ...
        assertTrue(w.add(new Balloon("atMidpoint", 512, 100, 100, 10, 10, 10,
            "hot", 5)));
        tree = w.printbintree();
        ...
        assertTrue(w.add(new Balloon("endAtMid", 502, 100, 100, 10, 10, 10,
            "hot", 5)));
        tree = w.printbintree();
        ...
        // ============================================================
        assertTrue(w.add(new Drone("crossMid", 500, 100, 100, 50, 10, 10,
            "brand", 2)));
        tree = w.printbintree();
        ...
        // ============================================================
        // Create deep tree structure
        assertTrue(w.add(new Balloon("d1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d2", 100, 100, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d3", 100, 600, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d4", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d5", 600, 600, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d6", 600, 100, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d7", 100, 600, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("d8", 600, 600, 600, 10, 10, 10, "hot",
            5)));
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("i1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("i2", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        w.delete("i1");
        assertTrue(w.add(new Balloon("i3", 100, 600, 100, 10, 10, 10, "hot",
            5)));
        w.delete("i2");
        assertTrue(w.add(new Balloon("i4", 600, 600, 100, 10, 10, 10, "hot",
            5)));
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("cap1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("cap2", 110, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("cap3", 120, 100, 100, 10, 10, 10, "hot",
            5)));
        // Leaf at capacity (3)
        ...
        assertTrue(w.add(new Balloon("cap4", 130, 100, 100, 10, 10, 10, "hot",
            5)));
        // Leaf back to 3
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("sm1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("sm2", 110, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("sm3", 120, 100, 100, 10, 10, 10, "hot",
            5)));
        // Force split by adding 4th in different region
        assertTrue(w.add(new Balloon("sm4", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        ...
        assertTrue(w.add(new Balloon("c001", 0, 0, 1010, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c010", 0, 1010, 0, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c011", 0, 1010, 1010, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c100", 1010, 0, 0, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c101", 1010, 0, 1010, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c110", 1010, 1010, 0, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("c111", 1010, 1010, 1010, 10, 10, 10,
            "hot", 5)));
        ...
        assertTrue(w.add(new Balloon("ov1", 100, 100, 100, 100, 100, 100, "hot",
            5)));
        assertTrue(w.add(new Balloon("ov2", 150, 150, 150, 100, 100, 100, "hot",
            5)));
        assertTrue(w.add(new Balloon("ov3", 120, 120, 120, 100, 100, 100, "hot",
            5)));
        ...
        // ============================================================
        // EDGE CASE 13: 4+ overlapping objects (exceeds capacity but won't
        // split)
        // ============================================================
        assertTrue(w.add(new Balloon("all1", 100, 100, 100, 200, 200, 200,
            "hot", 5)));
        assertTrue(w.add(new Balloon("all2", 110, 110, 110, 200, 200, 200,
            "hot", 5)));
        assertTrue(w.add(new Balloon("all3", 120, 120, 120, 200, 200, 200,
            "hot", 5)));
        assertTrue(w.add(new Balloon("all4", 130, 130, 130, 200, 200, 200,
            "hot", 5)));
        ...
        // ============================================================
        assertTrue(w.add(new Drone("huge", 100, 100, 100, 800, 800, 800, "mega",
            4)));
        assertTrue(w.add(new Balloon("tiny1", 50, 50, 50, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("tiny2", 950, 950, 950, 10, 10, 10, "hot",
            5)));
        ...
        // ============================================================
        for (int i = 0; i < 10; i++) {
            assertTrue(w.add(new Balloon("rapid" + i, 100, 100, 100, 10, 10, 10,
                "hot", 5)));
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("ml1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("ml2", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("ml3", 110, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("ml4", 610, 100, 100, 10, 10, 10, "hot",
            5)));
        ...
        assertTrue(w.add(new Balloon("chain1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("chain2", 100, 100, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("chain3", 100, 600, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("chain4", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        ...
        assertTrue(w.add(new Balloon("edge2", 1023, 1023, 1023, 1, 1, 1, "hot",
            5)));
        ...
        // ============================================================
        assertTrue(w.add(new Drone("span1", 400, 400, 400, 300, 300, 300, "b",
            2)));
        assertTrue(w.add(new Drone("span2", 450, 450, 450, 300, 300, 300, "b",
            2)));
        assertTrue(w.add(new Drone("span3", 350, 350, 350, 300, 300, 300, "b",
            2)));
        ...
        assertTrue(w.add(new Balloon("nest1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("nest2", 100, 100, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("nest3", 100, 600, 100, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("nest4", 100, 600, 600, 10, 10, 10, "hot",
            5)));
        assertTrue(w.add(new Balloon("nest5", 600, 100, 100, 10, 10, 10, "hot",
            5)));
        ...
        // ============================================================
        assertTrue(w.add(new Balloon("real1", 100, 100, 100, 10, 10, 10, "hot",
            5)));
        w.delete("real1");
        ...
        for (int i = 0; i < 20; i++) {
            ...
            int y = ((i / 4) % 4) * 250 + 10;
            int z = (i / 16) * 500 + 10;
            assertTrue(w.add(new Balloon(names[i], x, y, z, 20, 20, 20, "hot",
                5)));
        }

        // Delete in weird order
        int[] deleteOrder = { 7, 2, 15, 0, 19, 8, 4, 11, 16, 3, 12, 6, 18, 1,
            14, 9, 5, 17, 10, 13 };
    ...
    // ----------------------------------------------------------
    /**
     * Tests BinTree.intersect edge-case test covering empty tree, boundary
     * touches, quadrant queries, and spanning objects.
     *
     * @throws Exception
     *             if an error occurs during the test.
     */
    public void testBinTreeIntersectEdgeCases() throws Exception {
        WorldDB w = new WorldDB(null);

        // Empty world: just the flyweight root is visited
        String result = w.intersect(0, 0, 0, 10, 10, 10);
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 10 10 10):\r\n"
                + "1 nodes were visited in the bintree\r\n", result);

        // Boundary-touching query should not report the object
        w.clear();
        assertTrue(w.add(new Balloon("boundary", 100, 100, 100, 50, 50, 50,
            "hot", 5)));
        result = w.intersect(0, 0, 0, 100, 100, 100);
        System.out.println("Result for boundary test: \n" + result);
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 100 100 100):\r\n"
                + "In leaf node (0, 0, 0, 1024, 1024, 1024) 0\r\n"
                + "1 nodes were visited in the bintree\r\n" + "\r\n", result);
        assertFalse(result.contains("boundary"));
        // Overlap by a single unit should now include the object
        result = w.intersect(0, 0, 0, 101, 101, 101);
        System.out.println("Result for boundary overlap test: \n" + result);
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 101 101 101):\r\n"
                + "In leaf node (0, 0, 0, 1024, 1024, 1024) 0\r\n"
                + "Balloon boundary 100 100 100 50 50 50 hot 5\r\n"
                + "1 nodes were visited in the bintree", result);
        assertTrue(result.contains("boundary"));

        // Build a world that forces internal nodes across all axes
        w.clear();
        assertTrue(w.add(new Balloon("leftEdge", 100, 100, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("rightEdge", 700, 100, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("topEdge", 100, 700, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("deepEdge", 100, 100, 700, 10, 10, 10,
            "hot", 5)));

        // Left-half query should see only left-side residents
        result = w.intersect(0, 0, 0, 512, 1024, 1024);
        assertTrue(result.contains("left"));
        assertFalse(result.contains("right"));

        // Right-half (high Y) query should only hit the top object
        result = w.intersect(0, 550, 0, 1024, 400, 1024);
        assertFalse(result.contains("left"));
        assertTrue(result.contains("top"));

        // Back-half (high Z) query should only hit the deep object
        result = w.intersect(0, 0, 550, 1024, 1024, 400);
        assertFalse(result.contains("left"));
        assertTrue(result.contains("deep"));

        // Add a spanning object that crosses the X midpoint
        assertTrue(w.add(new Drone("spanBoth", 400, 100, 100, 300, 50, 50,
            "brand", 2)));

        // Full-world query should list everything exactly once
        result = w.intersect(0, 0, 0, 1024, 1024, 1024);
        assertTrue(result.contains("spanBoth"));
        assertTrue(result.contains("leftEdge"));
        assertTrue(result.contains("rightEdge"));
        assertTrue(result.contains("topEdge"));
        assertTrue(result.contains("deepEdge"));
        System.out.println("Result for full-world query: \n" + result);
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 1024 1024 1024):\r\n"
                + "In Internal node (0, 0, 0, 1024, 1024, 1024) 0\r\n"
                + "In Internal node (0, 0, 0, 512, 1024, 1024) 1\r\n"
                + "In leaf node (0, 0, 0, 512, 512, 1024) 2\r\n"
                + "Balloon deepEdge 100 100 700 10 10 10 hot 5\r\n"
                + "Balloon leftEdge 100 100 100 10 10 10 hot 5\r\n"
                + "Drone spanBoth 400 100 100 300 50 50 brand 2\r\n"
                + "In leaf node (0, 512, 0, 512, 512, 1024) 2\r\n"
                + "Balloon topEdge 100 700 100 10 10 10 hot 5\r\n"
                + "In leaf node (512, 0, 0, 512, 1024, 1024) 1\r\n"
                + "Balloon rightEdge 700 100 100 10 10 10 hot 5\r\n"
                + "5 nodes were visited in the bintree\r\n", result);

        // Query that only touches the right side should still find the span
        result = w.intersect(700, 0, 0, 100, 1024, 1024);
        System.out.println("Result for right-edge query: \n" + result);
        assertFuzzyEquals(
            "The following objects intersect (700 0 0 100 1024 1024):\r\n"
                + "In Internal node (0, 0, 0, 1024, 1024, 1024) 0\r\n"
                + "In leaf node (512, 0, 0, 512, 1024, 1024) 1\r\n"
                + "Balloon rightEdge 700 100 100 10 10 10 hot 5\r\n"
                + "2 nodes were visited in the bintree\r\n", result);

        // Query far from every object should traverse internal nodes but list
        // none
        result = w.intersect(900, 900, 900, 50, 50, 50);
        System.out.println("Result for empty-region query: \n" + result);
        assertFuzzyEquals(
            "The following objects intersect (900 900 900 50 50 50):\r\n"
                + "In Internal node (0, 0, 0, 1024, 1024, 1024) 0\r\n"
                + "In leaf node (512, 0, 0, 512, 1024, 1024) 1\r\n"
                + "2 nodes were visited in the bintree\r\n", result);
        assertTrue(result.contains("In Internal node"));
        assertFalse(result.contains("leftEdge"));
        assertFalse(result.contains("rightEdge"));
