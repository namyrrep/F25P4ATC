...
public class AirControlTest extends TestCase {
    ...
    public void testInternalNodeSimplification() throws Exception {
        ...
        assertTrue(w.add(new Balloon("left1", 100, 100, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("left2", 200, 100, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("right1", 600, 100, 100, 10, 10, 10,
            "hot", 5)));
        assertTrue(w.add(new Balloon("right2", 700, 100, 100, 10, 10, 10,
            "hot", 5)));
    ...
    public void testCollisionBoundaryConditions() throws Exception {
        ...
        // Intersection origin = (15, 15, 15) which is in region (0,0,0,512,512,1024)
        assertTrue(w.add(new Balloon("baseA", 10, 10, 10, 20, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("baseB", 15, 15, 15, 20, 20, 20, "hot", 5)));
        
        String collisions = w.collisions();
        assertTrue(collisions.contains("baseA") && collisions.contains("baseB"));
        ...
        assertTrue(w.add(new Balloon("edgeXA", 0, 10, 10, 20, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("edgeXB", 5, 15, 15, 20, 20, 20, "hot", 5)));
        // Intersection X = max(0, 5) = 5, which is >= 0
        collisions = w.collisions();
        assertTrue(collisions.contains("edgeXA") && collisions.contains("edgeXB"));
        ...
        assertTrue(w.add(new Balloon("edgeYA", 10, 0, 10, 20, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("edgeYB", 15, 5, 15, 20, 20, 20, "hot", 5)));
        // Intersection Y = max(0, 5) = 5, which is >= 0
        collisions = w.collisions();
        assertTrue(collisions.contains("edgeYA") && collisions.contains("edgeYB"));
        ...
        assertTrue(w.add(new Balloon("edgeZA", 10, 10, 0, 20, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("edgeZB", 15, 15, 5, 20, 20, 20, "hot", 5)));
        // Intersection Z = max(0, 5) = 5, which is >= 0
        collisions = w.collisions();
        assertTrue(collisions.contains("edgeZA") && collisions.contains("edgeZB"));
        ...
        // This tests that collision is NOT reported when origin is outside region
        // Objects span across x=512 boundary
        assertTrue(w.add(new Balloon("spanA", 500, 10, 10, 50, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("spanB", 520, 15, 15, 50, 20, 20, "hot", 5)));
        ...
        assertTrue(w.add(new Balloon("upperXA", 500, 10, 10, 10, 20, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("upperXB", 505, 15, 15, 10, 20, 20, "hot", 5)));
        // Intersection X = 505, in left region (0-512), should be reported
        collisions = w.collisions();
        assertTrue(collisions.contains("upperXA") && collisions.contains("upperXB"));
        ...
        assertTrue(w.add(new Balloon("upperYA", 10, 500, 10, 20, 10, 20, "hot", 5)));
        assertTrue(w.add(new Balloon("upperYB", 15, 505, 15, 20, 10, 20, "hot", 5)));
        // Intersection Y = 505, in region (0-512 for Y at this level)
        collisions = w.collisions();
        assertTrue(collisions.contains("upperYA") && collisions.contains("upperYB"));
        ...
        assertTrue(w.add(new Balloon("upperZA", 10, 10, 500, 20, 20, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("upperZB", 15, 15, 505, 20, 20, 10, "hot", 5)));
        // Intersection Z = 505
        collisions = w.collisions();
        assertTrue(collisions.contains("upperZA") && collisions.contains("upperZB"));
        
        w.delete("upperZA");
        w.delete("upperZB");

        // Test 9: Multiple overlapping objects to test all boundary paths
        assertTrue(w.add(new Balloon("multi1", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("multi2", 120, 120, 120, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("multi3", 110, 110, 110, 50, 50, 50, "hot", 5)));
    ...
    public void testCollisionExactBoundaries() throws Exception {
        ...
        assertTrue(w.add(new Balloon("exact1", 0, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("exact2", 0, 110, 110, 50, 50, 50, "hot", 5)));
        // Intersection X = max(0, 0) = 0, exactly at region.x
        // Should be reported (>= is true for 0 >= 0)
        
        String collisions = w.collisions();
        assertTrue(collisions.contains("exact1") && collisions.contains("exact2"));
        
        w.delete("exact1");
        w.delete("exact2");

        // Test objects at origin (0, 0, 0)
        assertTrue(w.add(new Balloon("origin1", 0, 0, 0, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("origin2", 5, 5, 5, 10, 10, 10, "hot", 5)));
        // Intersection = (5, 5, 5), clearly in region
        
        collisions = w.collisions();
        assertTrue(collisions.contains("origin1") && collisions.contains("origin2"));
        
        w.delete("origin1");
        w.delete("origin2");

        // Test non-overlapping objects (no collision should be reported)
        assertTrue(w.add(new Balloon("noOverlap1", 0, 0, 0, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("noOverlap2", 100, 100, 100, 10, 10, 10, "hot", 5)));
        
        collisions = w.collisions();
        // Should NOT contain a collision between these two
        assertFalse(collisions.contains("noOverlap1") && collisions.contains("noOverlap2") 
            && collisions.contains(") and ("));
    ...
    public void testCollisionMultiRegionObjects() throws Exception {
        ...
        assertTrue(w.add(new Drone("bigA", 400, 100, 100, 200, 50, 50, "brand", 2)));
        assertTrue(w.add(new Drone("bigB", 450, 110, 110, 200, 50, 50, "brand", 2)));
        ...
        assertTrue(w.add(new Drone("spanY1", 100, 400, 100, 50, 200, 50, "brand", 2)));
        assertTrue(w.add(new Drone("spanY2", 110, 450, 110, 50, 200, 50, "brand", 2)));
        ...
        assertTrue(w.add(new Drone("spanZ1", 100, 100, 400, 50, 50, 200, "brand", 2)));
        assertTrue(w.add(new Drone("spanZ2", 110, 110, 450, 50, 50, 200, "brand", 2)));
        // Intersection Z = 450
    ...
    public void testIntersectsAllConditions() throws Exception {
        ...
        assertTrue(w.add(new Balloon("ov1", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("ov2", 120, 120, 120, 50, 50, 50, "hot", 5)));
        String collisions = w.collisions();
        ...
        assertTrue(w.add(new Balloon("xFail1a", 200, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("xFail1b", 100, 100, 100, 50, 50, 50, "hot", 5)));
        // obj1 at 200, obj2 ends at 150, no overlap
        collisions = w.collisions();
        assertFalse(collisions.contains("xFail1a") && collisions.contains("xFail1b")
            && collisions.indexOf("xFail1a") < collisions.indexOf(") and ("));
        w.delete("xFail1a");
        w.delete("xFail1b");

        // Test 3: X - fail condition 2 (obj1.xOrg + obj1.xWidth <= obj2.xOrg)
        // obj1 is completely to the left of obj2
        assertTrue(w.add(new Balloon("xFail2a", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("xFail2b", 200, 100, 100, 50, 50, 50, "hot", 5)));
        // obj1 ends at 150, obj2 starts at 200, no overlap
        collisions = w.collisions();
        assertFalse(collisions.contains("xFail2a") && collisions.contains("xFail2b")
            && collisions.indexOf("xFail2a") < collisions.indexOf(") and ("));
        w.delete("xFail2a");
        w.delete("xFail2b");

        // Test 4: Y - fail condition 3 (obj1.yOrg >= obj2.yOrg + obj2.yWidth)
        // obj1 is completely below obj2 (higher Y value)
        assertTrue(w.add(new Balloon("yFail1a", 100, 200, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("yFail1b", 100, 100, 100, 50, 50, 50, "hot", 5)));
        collisions = w.collisions();
        assertFalse(collisions.contains("yFail1a") && collisions.contains("yFail1b")
            && collisions.indexOf("yFail1a") < collisions.indexOf(") and ("));
        w.delete("yFail1a");
        w.delete("yFail1b");

        // Test 5: Y - fail condition 4 (obj1.yOrg + obj1.yWidth <= obj2.yOrg)
        // obj1 is completely above obj2 (lower Y value)
        assertTrue(w.add(new Balloon("yFail2a", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("yFail2b", 100, 200, 100, 50, 50, 50, "hot", 5)));
        collisions = w.collisions();
        assertFalse(collisions.contains("yFail2a") && collisions.contains("yFail2b")
            && collisions.indexOf("yFail2a") < collisions.indexOf(") and ("));
        w.delete("yFail2a");
        w.delete("yFail2b");

        // Test 6: Z - fail condition 5 (obj1.zOrg >= obj2.zOrg + obj2.zWidth)
        assertTrue(w.add(new Balloon("zFail1a", 100, 100, 200, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("zFail1b", 100, 100, 100, 50, 50, 50, "hot", 5)));
        collisions = w.collisions();
        assertFalse(collisions.contains("zFail1a") && collisions.contains("zFail1b")
            && collisions.indexOf("zFail1a") < collisions.indexOf(") and ("));
        w.delete("zFail1a");
        w.delete("zFail1b");

        // Test 7: Z - fail condition 6 (obj1.zOrg + obj1.zWidth <= obj2.zOrg)
        assertTrue(w.add(new Balloon("zFail2a", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("zFail2b", 100, 100, 200, 50, 50, 50, "hot", 5)));
        collisions = w.collisions();
        assertFalse(collisions.contains("zFail2a") && collisions.contains("zFail2b")
            && collisions.indexOf("zFail2a") < collisions.indexOf(") and ("));
        w.delete("zFail2a");
        w.delete("zFail2b");

        // Test 8: Touching edges (boundary case - should NOT intersect)
        // X edges touch exactly
        assertTrue(w.add(new Balloon("touchX1", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("touchX2", 150, 100, 100, 50, 50, 50, "hot", 5)));
        collisions = w.collisions();
        // Edges touch at x=150, but don't overlap (< not <=)
        assertFalse(collisions.contains("touchX1") && collisions.contains("touchX2")
            && collisions.indexOf("touchX1") < collisions.indexOf(") and ("));
        w.delete("touchX1");
        w.delete("touchX2");

        // Test 9: Barely overlapping by 1 unit
        assertTrue(w.add(new Balloon("barelyX1", 100, 100, 100, 51, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("barelyX2", 150, 100, 100, 50, 50, 50, "hot", 5)));
        // obj1 ends at 151, obj2 starts at 150 - they overlap by 1
        collisions = w.collisions();
        assertTrue(collisions.contains("barelyX1") && collisions.contains("barelyX2"));
        w.delete("barelyX1");
        w.delete("barelyX2");
    }
    ...
    public void testRegionIntersectsQuery() throws Exception {
        ...
        assertTrue(w.add(new Balloon("left", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("right", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("top", 100, 600, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("deep", 100, 100, 600, 10, 10, 10, "hot", 5)));
    ...
    public void testObjectIntersectsQuery() throws Exception {
        ...
        assertTrue(w.add(new Balloon("target", 100, 100, 100, 50, 50, 50, "hot", 5)));
        ...
        // obj.xOrg + obj.xWidth > qx should be false when obj.xOrg + obj.xWidth <= qx
        ...
        // Query ends at x=100, object starts at x=100 (< not <=, so no intersect)
        assertFalse(result.contains("target"));
    ...
    public void testIntersectionEdgeCases() throws Exception {
        ...
        // Zero-size query - edge case
        assertFalse(result.contains("atOrigin"));
        
        w.delete("atOrigin");

        // Test objects at max boundary
        assertTrue(w.add(new Balloon("atMax", 1000, 1000, 1000, 20, 20, 20, "hot", 5)));
        ...
        assertTrue(w.add(new Balloon("yTouch", 100, 100, 100, 50, 50, 50, "hot", 5)));
    ...
    public void testInternalNodeInsertAllAxes() throws Exception {
        ...
        assertTrue(w.add(new Balloon("xLeft", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("xRight", 600, 100, 100, 10, 10, 10, "hot", 5)));
        ...
        assertTrue(w.add(new Balloon("yLow", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("yHigh", 100, 600, 100, 10, 10, 10, "hot", 5)));
        
        tree = w.printbintree();
        assertTrue(tree.contains("yHigh"));
        
        // Level 2: Z axis (level % 3 = 2)
        assertTrue(w.add(new Balloon("zFront", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("zBack", 100, 100, 600, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeInsertLeftRightBoth() throws Exception {
        ...
        assertTrue(w.add(new Balloon("leftOnly1", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("leftOnly2", 150, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("leftOnly3", 200, 100, 100, 50, 50, 50, "hot", 5)));
        
        // Add object to right side - this should force a split since left is full
        assertTrue(w.add(new Balloon("rightOnly", 600, 100, 100, 50, 50, 50, "hot", 5)));
        ...
        assertTrue(w.add(new Drone("spansBoth", 400, 100, 100, 300, 50, 50, "brand", 2)));
        // Object from x=400 to x=700, spans across x=512 midpoint
        
        tree = w.printbintree();
        // spansBoth should appear in multiple leaves (both left and right subtrees)
        int count = 0;
        int idx = 0;
        ...
        assertTrue("Spanning object should appear in at least 2 leaves", count >= 2);
    ...
    public void testInternalNodeRemoveAllAxes() throws Exception {
        ...
        assertTrue(w.add(new Balloon("rem1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("rem2", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("rem3", 100, 600, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("rem4", 100, 100, 600, 10, 10, 10, "hot", 5)));
        
        // Remove from different positions - exercises remove at different levels
    ...
    public void testInternalNodeRemoveSpanning() throws Exception {
        ...
        assertTrue(w.add(new Balloon("keeper1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("keeper2", 150, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("keeper3", 200, 100, 100, 10, 10, 10, "hot", 5)));
        
        // Add object to right side to force split
        assertTrue(w.add(new Balloon("rightKeeper", 600, 100, 100, 10, 10, 10, "hot", 5)));
        ...
        assertTrue(w.add(new Drone("spanning", 400, 100, 100, 300, 50, 50, "brand", 2)));
        ...
        assertTrue("Spanning object should be in at least 2 leaves", countBefore >= 2);
     ...
     * @throws Exception if an error occurs during the test.
     */
    public void testInternalNodeSimplifyLeftFlyweightRightLeaf() throws Exception {
        WorldDB w = new WorldDB(null);

        // Fill left side to capacity to force split when right is added
        assertTrue(w.add(new Balloon("leftSide1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("leftSide2", 150, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("leftSide3", 200, 100, 100, 10, 10, 10, "hot", 5)));
        
        // Add object to right side - forces split into internal node
        assertTrue(w.add(new Balloon("rightSide", 600, 100, 100, 10, 10, 10, "hot", 5)));
     ...
     * @throws Exception if an error occurs during the test.
     */
    public void testInternalNodeSimplifyLeftLeafRightFlyweight() throws Exception {
        WorldDB w = new WorldDB(null);

        // Fill right side to capacity to force split
        assertTrue(w.add(new Balloon("rightSide1", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("rightSide2", 650, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("rightSide3", 700, 100, 100, 10, 10, 10, "hot", 5)));
        
        // Add object to left side - forces split into internal node
        assertTrue(w.add(new Balloon("leftSide2", 100, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeSimplifyBothFlyweight() throws Exception {
        ...
        assertTrue(w.add(new Balloon("bothLeft1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("bothLeft2", 150, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("bothLeft3", 200, 100, 100, 10, 10, 10, "hot", 5)));
        
        // Add to right side - forces internal node
        assertTrue(w.add(new Balloon("bothRight", 600, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeLeafMerge() throws Exception {
        ...
        assertTrue(w.add(new Balloon("mergeL1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("mergeL2", 200, 100, 100, 10, 10, 10, "hot", 5)));
        
        // Add 2 objects to right side
        assertTrue(w.add(new Balloon("mergeR1", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("mergeR2", 700, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeLeafMergeExactlyThree() throws Exception {
        ...
        assertTrue(w.add(new Balloon("ex3L1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("ex3L2", 200, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("ex3R1", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("ex3R2", 700, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodePrintMultipleLevels() throws Exception {
        ...
        assertTrue(w.add(new Balloon("p1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("p2", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("p3", 100, 600, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("p4", 600, 600, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeCollisionsTraversal() throws Exception {
        ...
        assertTrue(w.add(new Balloon("collL1", 100, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("collL2", 120, 120, 120, 50, 50, 50, "hot", 5)));
        
        // Add colliding objects in right child
        assertTrue(w.add(new Balloon("collR1", 600, 100, 100, 50, 50, 50, "hot", 5)));
        assertTrue(w.add(new Balloon("collR2", 620, 120, 120, 50, 50, 50, "hot", 5)));
    ...
    public void testInternalNodeIntersectLeftOnly() throws Exception {
        ...
        assertTrue(w.add(new Balloon("intLeft", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("intRight", 600, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeIntersectRightOnly() throws Exception {
        ...
        assertTrue(w.add(new Balloon("intLeft2", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("intRight2", 600, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeIntersectBothChildren() throws Exception {
        ...
        assertTrue(w.add(new Balloon("intBothL", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("intBothR", 600, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeIntersectMissBoth() throws Exception {
        ...
        assertTrue(w.add(new Balloon("missL", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("missR", 600, 100, 100, 10, 10, 10, "hot", 5)));
    ...
    public void testInternalNodeIntersectAllAxes() throws Exception {
        ...
        assertTrue(w.add(new Balloon("axX1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("axX2", 600, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("axY1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("axY2", 100, 600, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("axZ1", 100, 100, 100, 10, 10, 10, "hot", 5)));
        assertTrue(w.add(new Balloon("axZ2", 100, 100, 600, 10, 10, 10, "hot", 5)));
